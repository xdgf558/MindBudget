...
(`1ebb36c`). C3-03B now implements one source-level exception for the exact centralized adapter
and is implementation complete pending independent review. The Development Worker and real
adapter/verifier path have dated evidence; Staging and Production remain undeployed. This row does
