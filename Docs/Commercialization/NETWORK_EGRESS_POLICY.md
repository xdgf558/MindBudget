...
transport accepted incrementally by C2-01 through completed C2-04, merged C3-01, and the local
C3-02 trial-lifecycle implementation; it does not permit app-owned HTTP(S), automatic presentation, formal
