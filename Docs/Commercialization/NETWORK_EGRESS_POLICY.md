...
| App Attest/current entitlement | Deferred by DEC-COM-104; no domain or route | Not applicable to the local-only candidate | None | None | None | None | No cloud account/session | None | Remain local | REQ-CLOUD-AUTH-001 / deferred COM-C7/C10 |
| Cloud Coach | Deferred by DEC-COM-104; forbidden in the local-only candidate | Historical synthetic Eval only; no customer environment | None in the app or release backend; the historical synthetic Eval used the Global `https://api.openai.com/v1` base URL outside the product | None | None | None | No production consent because no provider route exists | Historical synthetic-Eval standard retention evidence only; no customer data or credit ledger | Deterministic template or supported on-device AI remains complete; no credit exists to commit | REQ-CLOUD-CONSENT-001, REQ-CLOUD-USAGE-001 / deferred COM-C8–C12; DEC-COM-095/096/097/104 |
