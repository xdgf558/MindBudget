...
| REQ-G1-001 | Active; owner selected `DEFER_LUNA_CREDITS_KEEP_LOCAL_PRO`, pending reviewed record closeout | v1.4 §19.2–19.5 plus DEC-COM-092 through DEC-COM-104 | After COM-C6; Watch remains separately gated | DEC-COM-094 preserves reviewed PR #98 (`9226985`, run `33570570896`, merge `6e2d242`) and historical `INSUFFICIENT_QUOTE_EVIDENCE`. DEC-COM-095/096 record the US$4.99 local-Pro/trial policy and historical Luna/card offer. DEC-COM-097/098/099 preserve synthetic-only account admission and the independently reviewed 24/24 Luna run. DEC-COM-100/101 preserve the physical three-way harness/capture delivery. DEC-COM-102 records completed-review SHA-256 `d2b9310f4471400825e666009f646a190d8ac2819f859c8e38d58ec05cbf040e` and deterministic `NON_PASS`: zero materially preferred Luna cases, no qualifying bilingual task, and no second eligible blind score. DEC-COM-103 closes only that result-recording delivery. DEC-COM-104 supplies the owner disposition but not its merge closeout: G1 remains In Progress at `LUNA_CREDITS_DEFERRED_PENDING_REVIEW_AND_CLOSEOUT`, no `PROCEED_TO_R2` is granted, Luna/cards and COM-C7 through COM-C11 are deferred, production remains false, and a separately authorized local-only COM-C12 path becomes eligible only after closeout | SPEC-013/014 accepted; DEC-COM-092/093/094/095/096/097/098/099/100/101/102/103/104; `G1_UNIT_ECONOMICS_PACKET.md`; `G1_LUNA_EVAL.md`; `G1_OPENAI_ACCOUNT_EVIDENCE.md`; `G1_LUNA_EVAL_RESULT_2026-09-02.json`; `G1_THREE_WAY_EVAL.md`; `G1_APPLE_ON_DEVICE_EVAL_TRANSCRIPT_2026-09-02.jsonl`; `G1_THREE_WAY_BLIND_REVIEW_2026-09-02.json`; `G1_THREE_WAY_REVIEW_SIDECAR_2026-09-02.json`; `G1_THREE_WAY_REVIEW_RESULT_2026-09-02.json`; `Scripts/g1_unit_economics.py`; `Scripts/g1_luna_eval.py` | P0 / G1 decision; future local-only COM-C12 entry |
...
DEC-COM-104 supplies the later owner disposition `DEFER_LUNA_CREDITS_KEEP_LOCAL_PRO`. REQ-G1-001
remains Active only until this decision record is independently reviewed, green, merged, and
closed; current state is `LUNA_CREDITS_DEFERRED_PENDING_REVIEW_AND_CLOSEOUT`. The frozen `NON_PASS`
and production-false evidence remain unchanged. REQ-CLOUD-AUTH-001, REQ-CLOUD-CONSENT-001, and
REQ-CLOUD-USAGE-001 are deferred rather than completed, and COM-C7 through COM-C11 are not entered.
A separately owner-entered local-only COM-C12 review becomes eligible only after G1 closeout.
