...
| REQ-ENTITLEMENT-001 | Active; C1-01 domain implemented, access integration pending | v1.4 §§6.1–6.5 | COM-C1; reused by C2–C12 and Watch | Parameterized union tests for every reachable `EntitlementSet`; Free fallback exact; deferred bits unreachable; no Release manual unlock | SPEC-008/017 accepted; DEC-COM-012 | P0 / COM-C1 onward |
