...
| REQ-G1-001 | Active; independent comparative Eval is NON_PASS and owner disposition is pending | v1.4 §19.2–19.5 plus DEC-COM-092/093/094/095/096/097/098/099/100/101/102 | After COM-C6; Watch remains separately gated | DEC-COM-094 preserves reviewed PR #98 (`9226985`, run `33570570896`, merge `6e2d242`) and historical `INSUFFICIENT_QUOTE_EVIDENCE`. DEC-COM-095 selects Luna and the US$4.99/local-trial/accounting policy. DEC-COM-096 accepts 10 starter credits plus 10/25/65-use cards at US$0.99/US$1.99/US$4.99; planning remains US$0.011330 typical/P50 and US$0.018986 peak/P95 at 1,000 successes. DEC-COM-097 accepts standard up-to-30-day retention for synthetic Eval only, pins Global/Luna-only/Tier 1/bounded-billing evidence, and keeps production false. DEC-COM-098 records confirmed disabled sharing/logging, Keychain credential isolation, two explicit non-pass attempts, and attempt 3's 24/24 first-pass automated result under prompt/schema hash `c1d9f76e6a87ce116cac009eafe56f1bd57b6118e04d9c5a421ba6fb78734018`. Independent review found no P1/P2 on PR #100 head `323d8d7`; hosted run `33593253561` passed and merge `7a473d2` delivered it. DEC-COM-099 closes only that account/Eval evidence delivery and preserves four nonblocking follow-ups. DEC-COM-100 records the fixed bilingual physical capture across deterministic template, supported on-device output, and the already reviewed Luna transcript: structured Apple output was emitted for 24/24 cases, mappings and diagnostics are sealed outside the scoring surface, and no new OpenAI request occurred. DEC-COM-101 closes only the PR #102 harness/capture delivery after exact remediation head `bb939d0` passed independent review and hosted run `33628847476`, then merged as `2254902`; only blind JSON SHA-256 `bcbf943ba7d6a1a9d18442efc38e760cc798c30e8674c8d877f9e0cb751ab2a5` could be scored by a different eligible reviewer before the sidecar was opened. DEC-COM-102 records completed-review SHA-256 `d2b9310f4471400825e666009f646a190d8ac2819f859c8e38d58ec05cbf040e` and deterministic `NON_PASS`: zero materially preferred Luna cases, no qualifying bilingual task, and no second eligible blind score for agreement. The former `EVAL_REVIEWED_PENDING_STOREFRONT_EVIDENCE` state is superseded by `COMPARATIVE_EVAL_NON_PASS_PENDING_OWNER_DECISION`. StoreKit Product-ID/price-point evidence, server breaker implementation/review, and remaining legal gates are unfulfilled, but owner disposition of the cloud-credit offer now comes first. Only a later owner `PROCEED_TO_R2` may enter COM-C7 | SPEC-013/014 accepted; DEC-COM-092/093/094/095/096/097/098/099/100/101/102; `G1_UNIT_ECONOMICS_PACKET.md`; `G1_LUNA_EVAL.md`; `G1_OPENAI_ACCOUNT_EVIDENCE.md`; `G1_LUNA_EVAL_RESULT_2026-09-02.json`; `G1_THREE_WAY_EVAL.md`; `G1_APPLE_ON_DEVICE_EVAL_TRANSCRIPT_2026-09-02.jsonl`; `G1_THREE_WAY_BLIND_REVIEW_2026-09-02.json`; `G1_THREE_WAY_REVIEW_SIDECAR_2026-09-02.json`; `G1_THREE_WAY_REVIEW_RESULT_2026-09-02.json`; `Scripts/g1_unit_economics.py`; `Scripts/g1_luna_eval.py` | P0 / COM-C7 entry |
