...
| REQ-RECEIPT-PIPELINE-001 | Active; C4C-01 Done, C4C-02 implementation pending review/CI/merge | v1.4 §9.6.1–9.6.9 | COM-C4C | C4C-01 centralizes future receipt rights and deterministic/local-model tiers. C4C-02 candidate owns source/Pro/permission/hardware capability, bounded ImageIO orientation/downsampling, geometry-only perspective correction, cancellation, and one protected temporary artifact. Focused result `/private/tmp/MindBudget-C4C02-Focused5.xcresult` passed 10/10. OCR/extraction/validation/confirmation, 60+ fixtures, 20-image stability, and no-save-before-confirmation remain C4C-03 through C4C-05 | SPEC-010 resolved; SPEC-015 accepted; DEC-COM-044/045; `COM_C4C_EXECUTION_PACKET.md` | P0 / local Pro and 1.0 |
| REQ-RECEIPT-PRIVACY-001 | Active; C4C-02 temporary-byte boundary pending review/CI/merge | v1.4 §1 rules 26–27, §9.6.6 | COM-C4C; verify C6/C8/C12 | Product entry remains disabled. PHPicker requests no broad library permission; camera permission is explicit-action-only. Source bytes are never written; the one bounded prepared JPEG is completely protected, excluded from backup, and removed on startup/cancel/background/memory/Delete All/teardown. No OCR result, SwiftData/iCloud field, log content, model prompt, or egress exists. Sensitive-pattern removal and confirmation-before-persistence remain C4C-03/C4C-05 | SPEC-010/012 accepted; DEC-COM-044/045; `COM_C4C_EXECUTION_PACKET.md` | P0 / local Pro, cloud AI, 1.0 |
