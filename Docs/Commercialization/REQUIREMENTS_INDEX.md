...
| REQ-STOREKIT-LIFECYCLE-001 | Active; COM-C2 complete, C3-01 implementation complete pending independent review/CI/merge | v1.4 §§7.1–7.8, 8.3 | COM-C2/C3; server verification C7/C10 | One `EntitlementStore` authority/lifecycle task; typed purchase/restore; verified status/renewal facts; publish before required `finish`; failed finish retry; pending/cancel/error grant nothing. C2-04 completed verified `AppTransaction` bundle/environment agreement and exact environment isolation. C3-01 adds voluntary Settings/value-trigger presentation, StoreKit `displayPrice`, optional actual offer plus fresh eligibility, explicit purchase/restore/manage controls, and HKG/USA/SGP/TWN test probes. Exact P1W is fixture evidence only; production catalog/authority ignores promotion presence and duration. Eligible paid/unknown introductory modes retain their StoreKit price/mode but pause purchase in both View and adapter; promotion shape never gates existing rights. Unavailable subscription authority blocks purchase in both View and actor with explicit recheck, and renewal disclosure uses the app locale. The final physical-device dedicated scheme passed 9/9 with all storefront and Monthly/Annual transaction probes executing. Formal products/final economics, lifecycle reminders, and distribution remain later gates | SPEC-005/006/014/017 accepted; DEC-COM-015/016/017/018/019 | P0 / paid TestFlight and 1.0 |
...
- Present after COM-C1 through completed and merged COM-C2: the closed entitlement/
  ...
  publish-before-finish, and unfinished retry. C3-01 adds voluntary customer-facing purchase,
  restore, and subscription-management presentation in unreleased source. Not present: formal App
