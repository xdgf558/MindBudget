...
| REQ-RECEIPT-PIPELINE-001 | Active; C4C-01/C4C-02 Done; C4C-03 implementation pending review/CI/merge | v1.4 §9.6.1–9.6.9 | COM-C4C | PR #69 merged the C4C-02 closeout as `3e1c5c9`, then the owner explicitly entered C4C-03. The candidate confines accurate local Vision OCR to one adapter, keeps normalized geometry/confidence, applies deterministic top-to-bottom/left-to-right ordering, and publishes only privacy-filtered lines under count/byte bounds. Seven focused tests pass. Structured extraction, exact field validation, confirmation, 60+ fixtures, 20-image stability, and persistence remain C4C-04/C4C-05 | SPEC-010 resolved; SPEC-015 accepted; DEC-COM-044/045/046/047; `COM_C4C_EXECUTION_PACKET.md` | P0 / local Pro and 1.0 |
| REQ-RECEIPT-PRIVACY-001 | Active; C4C-03 pre-model boundary implementation pending review/CI/merge | v1.4 §1 rules 26–27, §9.6.6 | COM-C4C; verify C6/C8/C12 | Product entry remains disabled. Raw OCR text cannot leave the exact Vision adapter/privacy pipeline; only a file-private-constructed `ReceiptModelSafeText` line may emerge after card-number, labelled/masked last-four, and authorization-code removal. Invalid geometry/confidence, filter failure, or bounded-input overflow rejects the document. No receipt content enters SwiftData, iCloud, logs, model prompts, HTTP(S), or telemetry. Confirmation-before-persistence remains C4C-05 | SPEC-010/012 accepted; DEC-COM-044/045/046/047; `COM_C4C_EXECUTION_PACKET.md` | P0 / local Pro, cloud AI, 1.0 |
