...
| REQ-G1-001 | Active; eligible for explicit owner entry after COM-C6, not entered | v1.4 §19.2–19.5 | After COM-C6; Watch remains separately gated | Every G1 row reports denominator/numerator/sample/confidence/segment; fixed eval version; dated quotes; P50/P95/retry/failover cost; signed owner decision | SPEC-013/014 accepted | P0 / COM-C7 entry |
