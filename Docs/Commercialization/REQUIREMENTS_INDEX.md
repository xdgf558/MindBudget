...
| REQ-STOREKIT-STATE-001 | Active; C2-02 authority merged; C2-03 full mapper implementation complete, pending independent review | v1.4 §7.5 | COM-C2 | Table tests prove subscribed/verified grace on; retry/expired/revoked/unknown/unverified/pending off; expiration alone never invents grace; incomplete free authority fails closed; cached state never permanently grants rights. Local focused/full validation is recorded; independent review, CI, and merge remain pending | SPEC-004 resolved; DEC-COM-016/017 | P0 / paid TestFlight and 1.0 |
| REQ-STOREKIT-LIFECYCLE-001 | Active; C2-01/C2-02 merged; C2-03 purchase/restore/finish implementation complete, pending independent review | v1.4 §§7.1–7.8, 8.3 | COM-C2/C3; server verification C7/C10 | One `EntitlementStore` authority and one lifecycle task supervising `Transaction.updates` plus `Product.SubscriptionInfo.Status.updates`; every status signal triggers a fresh full reconciliation, never a second authority; typed explicit purchase and restore; verified status/renewal facts; publish authoritative snapshot before required `finish`; failed finish remains unfinished for retry; pending/cancel/error grant nothing; CHN/USA entry probes passed on final physical iOS 26.6.1 `23G82`; environment isolation/dynamic price-trial/customer UI remain later gates. Local focused/full validation is recorded; independent review, CI, and merge remain pending | SPEC-005/006/014/017 accepted; DEC-COM-015/016/017 | P0 / paid TestFlight and 1.0 |
...
- Present after COM-C1/C2-02 and in the review-pending C2-03 candidate: the closed entitlement/
  ...
  publish-before-finish, and unfinished retry. Not present: customer-facing purchase/restore or
  paywall UI, formal App Store Connect products, CloudKit
