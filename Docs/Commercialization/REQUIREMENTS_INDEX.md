...
| REQ-RECEIPT-PIPELINE-001 | Active; C4C-01 through C4C-04 Done through PR #72 `e6316fa`; C4C-05 candidate In Progress | v1.4 §9.6.1–9.6.9 | COM-C4C | PR #73 merged the C4C-04 closeout as `2107723`, after which the owner explicitly entered C4C-05. The candidate exposes one verified-Pro entry in the new-expense form, runs image/OCR/extraction locally and off-main, copies only accepted merchant/date/total into editable fields, and leaves the existing explicit Save action as the sole persistence boundary. The checked-in deterministic matrix contains 60 exact USD/JPY/KWD receipts, 10 nonreceipts with no accepted total, offline tier checks, and 20 sequential real-image bounded cleanup iterations. Physical DataScanner/PHPicker/OCR evidence, independent review, hosted CI, and merge remain open; the Requirement is not Done | SPEC-010 resolved; SPEC-015 accepted; DEC-COM-044/045/046/047/048/049/050/051; `COM_C4C_EXECUTION_PACKET.md` | P0 / local Pro and 1.0 |
| REQ-RECEIPT-PRIVACY-001 | Active; C4C-03/C4C-04 boundaries Done; C4C-05 candidate In Progress | v1.4 §1 rules 26–27, §9.6.6 | COM-C4C; verify C6/C8/C12 | The verified-Pro customer entry is enabled only in the C4C-05 candidate. Source/prepared images, raw or filtered OCR, model evidence, and duplicate evidence remain ephemeral and never enter SwiftData, iCloud, logs, HTTP(S), telemetry, or a remote model. The optional model receives only privacy-filtered text and cannot override deterministic accepted/rejected authority. The zero-leak suite includes separated/full-width cards, labelled and continuous/spaced mask last-four forms, and authorization codes; review-prefill still writes nothing before explicit Save. Physical acquisition/OCR, review, CI, and merge remain open; the Requirement is not Done | SPEC-010/012 accepted; DEC-COM-044/045/046/047/048/049/050/051; `COM_C4C_EXECUTION_PACKET.md` | P0 / local Pro, cloud AI, 1.0 |
