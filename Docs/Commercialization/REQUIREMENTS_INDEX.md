...
| REQ-STOREKIT-LIFECYCLE-001 | Active; COM-C2 in progress at configuration-only C2-01; formal products evidence-gated | v1.4 §§7.1–7.8, 8.3 | COM-C2/C3; server verification C7/C10 | Exactly one lifecycle listener; verified transactions; required `finish`; purchase/restore/pending/cancel; environment isolation; dynamic price/trial/renewal; no entitlement loss on catalog failure | SPEC-005/006/014/017 accepted; DEC-COM-015 | P0 / paid TestFlight and 1.0 |
...
- Present after COM-C1/C2-01: the closed entitlement/access model, accepted technical Product IDs,
  and a test-bundle-only Xcode StoreKit Configuration fixture for Monthly/Annual. Not present:
  runtime StoreKit catalog/transactions/restore, formal App Store Connect products, CloudKit
