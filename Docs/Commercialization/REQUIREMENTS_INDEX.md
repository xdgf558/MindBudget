...
| REQ-CLOUD-USAGE-001 | Active, G1-gated and economics-gated | v1.4 §0.2–0.3, §14 | COM-C9; cost/config C11; verify C12 | DEC-COM-093 proposes, but does not accept, a server-authoritative ledger keyed from verified non-consumable authority, idempotent consumable grants, reserve/commit/release use counting, retry/failover without extra credit, refund deficit, deletion, reinstall/device recovery, no expiry, and a cost circuit breaker. DEC-COM-094 records independent review of the arithmetic and makes the low-volume/cost breaker a future server-enforced acceptance gate. Every rule remains implementation- and review-gated; deterministic local fallback and no “unlimited” claim remain mandatory | SPEC-012/014 accepted; DEC-COM-092/093/094 | P0 / cloud AI and 1.0 |
| REQ-G1-001 | Active; first quote/planning package reviewed and merged, Eval and decision open | v1.4 §19.2–19.5 plus DEC-COM-092/093/094 | After COM-C6; Watch remains separately gated | Official OpenAI/Anthropic/Google/Apple/Cloudflare quotes dated 2026-09-02; provisional OpenAI Luna/Anthropic Haiku cost candidates; reproducible integer-micro-USD US$0.011330 typical/P50 and US$0.033098 peak/P95 planning costs at 1,000 monthly successes; provisional US$4.99/10-starter and 10/25/65-card analysis; ledger/refund/retry/delete/recovery proposal. Independent review found no P1/P2 on exact PR #98 head `9226985`; run `33570570896` passed and PR #98 merged as `6e2d242`. Fixed bilingual provider Eval, account privacy/region/rate proof, exact App Store proceeds, final-decision review, and owner decision remain missing, so the interim outcome is `INSUFFICIENT_QUOTE_EVIDENCE` | SPEC-013/014 accepted; DEC-COM-092/093/094; `G1_UNIT_ECONOMICS_PACKET.md`; `Scripts/g1_unit_economics.py` | P0 / COM-C7 entry |
