...
| REQ-ENTITLEMENT-001 | Active; C1-01 domain and C1-02 central access injection implemented; entry integration pending | v1.4 §§6.1–6.5 | COM-C1; reused by C2–C12 and Watch | Parameterized union and full feature-access matrices; concurrent immutable reads; Free fallback exact; removal returns exact Free; deferred bits and raw-bit consumers unreachable; Debug provider absent Release; no Release manual unlock | SPEC-008/017 accepted; DEC-COM-012/013 | P0 / COM-C1 onward |
