...
| REQ-CLOUD-USAGE-001 | Active, G1-gated and economics-gated | v1.4 §0.2–0.3, §14 | COM-C9; cost/config C11; verify C12 | Server-authoritative integer credit ledger; idempotent counting; cancellation/retry/refund/delete rules; consumable-card verification and recovery boundary; tiered rate/body/token caps; cost circuit breaker; deterministic local fallback; no “unlimited” claim | SPEC-012/014 accepted; DEC-COM-092 | P0 / cloud AI and 1.0 |
| REQ-G1-001 | Active; owner-rescoped, not entered | v1.4 §19.2–19.5 plus DEC-COM-092 | After COM-C6; Watch remains separately gated | Dated primary/backup AI and backend quotes; fixed typical/P50 and peak/P95 request profiles; integer-micro-USD all-in cost; US$4.99 one-time unlock starter-credit analysis; at least three consumable-card options; exact ledger/refund/retry/delete/recovery terms; signed owner decision | SPEC-013/014 accepted; DEC-COM-092; `G1_UNIT_ECONOMICS_PACKET.md` | P0 / COM-C7 entry |
