...
| REQ-RECEIPT-PIPELINE-001 | Active; C4C-01 through C4C-03 Done through PR #70 `d294cfb`; C4C-04 implementation complete pending review | v1.4 §9.6.1–9.6.9 | COM-C4C | After PR #71 merged the C4C-03 closeout as `08fb718`, the owner explicitly entered C4C-04. The candidate runs deterministic extraction first, optionally permits an on-device model to select only exact snippets from the privacy-filtered document, and keeps merchant/date/currency/scale/minor-unit/range/duplicate validation deterministic. Missing or uncertain fields remain explicit and never become zero; model failure returns the deterministic result; line items default off. Confirmation, 60+ fixtures, 20-image stability, and persistence remain C4C-05 | SPEC-010 resolved; SPEC-015 accepted; DEC-COM-044/045/046/047/048/049; `COM_C4C_EXECUTION_PACKET.md` | P0 / local Pro and 1.0 |
| REQ-RECEIPT-PRIVACY-001 | Active; C4C-03 pre-model boundary Done through PR #70 `d294cfb`; C4C-04 implementation complete pending review | v1.4 §1 rules 26–27, §9.6.6 | COM-C4C; verify C6/C8/C12 | Product entry remains disabled. Raw OCR text cannot leave the exact Vision adapter/privacy pipeline. C4C-04 accepts only `ReceiptOCRDocument`; its optional Foundation Models adapter runs on device, receives only already-filtered text, and can return only evidence that deterministic code proves exists in that document. No receipt content enters SwiftData, iCloud, logs, HTTP(S), telemetry, or a remote model. Confirmation-before-persistence remains C4C-05 | SPEC-010/012 accepted; DEC-COM-044/045/046/047/048/049; `COM_C4C_EXECUTION_PACKET.md` | P0 / local Pro, cloud AI, 1.0 |
