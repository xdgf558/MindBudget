...
Account admission, the live Luna run, StoreKit price-point evidence, final review, and owner
decision remain open under `ACCOUNT_ADMISSION_AND_LIVE_EVAL_BLOCKED`; no product/backend mutation
is authorized.
