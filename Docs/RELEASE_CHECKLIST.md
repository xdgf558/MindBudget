...
- [x] Release configuration remains TestFlight candidate version 0.9.2/build 3, iPhone-only,
...
- [ ] Archive Release 0.9.2 (3), validate it in Organizer, and inspect the
