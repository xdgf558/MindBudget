...
- Previous uploaded candidate: version 0.9.6, build 7 (transport accepted 2026-08-10)
...
- Builds 7 and 8 are immutable. Increment to build 9 before uploading any replacement.
